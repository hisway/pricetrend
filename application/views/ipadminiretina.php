...
<head>  
	...
	var url  = 'data/index/ipadmire/16';
	$.ajax({
	    type : "GET",
	    url  : url,
	    dataType : "json",
	    success: function(items) {
		    ...
		    {      
				...
				title:{
					text: "iPad Mini Retina WiFi 16G 港版价格走势图",
					fontColor:"#185385",
				},
				toolTip: {
					shared: true,
	...
	var url  = 'data/index/ipadmire/32';
	$.ajax({
	    type : "GET",
	    url  : url,
	    dataType : "json",
	    success: function(items) {
		    ...
		    {      
				...
				//backgroundColor: "#185385",
				title:{
					text: "iPad Mini Retina WiFi 32G 港版价格走势图",
					fontColor:"#185385",
				},
				toolTip: {
					shared: true,
	...
	var url  = 'data/index/ipadmire4/16';
	$.ajax({
	    type : "GET",
	    url  : url,
	    dataType : "json",
	    success: function(items) {
		    ...
		    {      
				...
				//backgroundColor: "#185385",
				title:{
					text: "iPad Mini Retina 4G+WiFi 16G 港版价格走势图",
					fontColor:"#185385",
				},
				toolTip: {
					shared: true,
	...
	var url  = 'data/index/ipadmire4/32';
	$.ajax({
	    type : "GET",
	    url  : url,
	    dataType : "json",
	    success: function(items) {
		    ...
		    {      
				...
				//backgroundColor: "#185385",
				title:{
					text: "iPad Mini Retina 4G+WiFi 32G 港版价格走势图",
					fontColor:"#185385",
				},
				toolTip: {
					shared: true,
...
<title>Apple 产品港版价格走势-iPad Mini Retina</title>
