	...
	$.ajax({
	    ...
	    success: function(items) {
		    ...
		    {      
				...
				title:{
					text: "iPad Air WiFi 16G 港版价格走势图",
					fontColor:"#185385",
				},
				toolTip: {
					shared: true,
	...
	$.ajax({
	    ...
	    success: function(items) {
		    ...
		    {      
				...
				//backgroundColor: "#185385",
				title:{
					text: "iPad Air WiFi 32G 港版价格走势图",
					fontColor:"#185385",
				},
				toolTip: {
					shared: true,
	...
	$.ajax({
	    ...
	    success: function(items) {
		    ...
		    {      
				...
				//backgroundColor: "#185385",
				title:{
					text: "iPad Air 4G+WiFi 16G 港版价格走势图",
					fontColor:"#185385",
				},
				toolTip: {
					shared: true,
	...
	$.ajax({
	    ...
	    success: function(items) {
		    ...
		    {      
				...
				//backgroundColor: "#185385",
				title:{
					text: "iPad Air 4G+WiFi 32G 港版价格走势图",
					fontColor:"#185385",
				},
				toolTip: {
					shared: true,
...
<title>Apple 产品港版价格走势-iPad Air</title>
